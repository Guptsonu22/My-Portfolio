...
export default function Resume() {
  ...
  return (
    <section id="resume" className="py-32 bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="container mx-auto px-6">
        ...
        >
          <Card className="overflow-hidden shadow-lg bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500">
