...
import { Code, Terminal, Database, Monitor, Cloud } from "lucide-react"
...
export default function TechnicalSkills() {
  return (
    <section id="skills" className="py-16 md:py-32 bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-8 md:mb-16 text-center text-white">Technical Skills</h2>
